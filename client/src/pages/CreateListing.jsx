        ...
        <form className="flex flex-col sm:flex-row gap-4">
            ...
            <div className=" flex flex-col flex-1 gap-4">
                ...
                <div className="flex gap-4">
                    <input type="file" id='image' accept='image/*' multiple className='p-3 border border-gray-300 rounded w-full' />
                    <button className='bg-blue-500 text-white p-3 rounded uppercase hover:shadow-lg disabled:opacity-80'>Upload</button>
                </div>
